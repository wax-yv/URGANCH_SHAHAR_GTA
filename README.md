...
- P — parkovka, L — fara, N — kun/tun, G — shahar info, Space — ruchnoy tormoz, C — orqa kamera, V — kamera rejim, H — foto rejim, T — landmark teleport, R — mashina rescue, L — fara
...
3D modellar: Kenney.nl Car Kit + Train Kit (CC0), Poly Pizza — "Car Hatchback" (Kay Lousberg, CC0), "Bus" (jeremy, CC-BY), "Car" (Quaternius, CC0).
